...
class Monitor:
        ...
        while True:
            try:
                ...
                if instr == '?':
                    ...
                    ### ADDED CODE ###
                    # Add another option (R) to the menu
                ...
                ### CODE ADDED ###
                # This adds the option when user puts R into the terminal in MON> it will call the _run_batch function
    ...
    ### CODE ADDED ###
    # Defined the function for _run_batch (Very simillary to _run_program. only difference is that it takes in boolean value
    # to determine whether we are batching the program or just running the program)
